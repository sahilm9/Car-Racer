...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)('#go').click(function () {
    ...
    */
    var carWidth = (0, _jquery2.default)('#car1').width();
    /*
    ...
    */
    ...
    (0, _jquery2.default)('#car1').animate({
      ...
      (0, _jquery2.default)('#raceInfoContainer__raceInfo1 span').text('Finished in ' + finishedPlace + ' and reached in ' + car1RaceTime + ' milliseconds');
    });
    // jQuery Animate method
    (0, _jquery2.default)('#car2').animate({
      // Moving the car to the width of the race track
      left: raceTrackWidth
      ...
      // check to see if a car has completed the race already
      checkIfComplete();
      (0, _jquery2.default)('#raceInfoContainer__raceInfo2 span').text('Finished in ' + finishedPlace + ' and reached in ' + car2RaceTime + ' milliseconds');
    });
  });
